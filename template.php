...
<script>
  ...
  const showTemplateCurrencies = () => {
    ...
    fetchUser().then(res=>res.json()).then(data=>{
      ...
      xhr.open('GET', `http://localhost/rahat/api/template/template/all/${data?.email}`, true);
      var results = [];
  ...
  submitForm.addEventListener("submit", function(event){
    ...
    // Set the request URL and method
      xhr.open("POST", "http://localhost/rahat/api/template/template/", true);
...
const editTemplateCurrencies = (currencyId)=>{
  ...
  var xhr = new XMLHttpRequest();
  xhr.open('GET', `http://localhost/rahat/api/template/template/${id}`, true);
...
updateCurrencyForm.addEventListener("submit", function(event){
  ...
  xhr.open('PUT', 'http://localhost/rahat/api/template/template/' + currencyId, true);
